...
// The dimension of the system
        ...
        public:
            ...
            Pc2MeshPoissonData(Eigen::Vector3d normal)
        ...
        void ExtractMesh(
            ...
            for (size_t vidx = 0; vidx < mesh->outOfCorePointCount(); ++vidx) {
                ...
                out_mesh.indices.template emplace_back(v.point[0], v.point[1], v.point[2]);
                out_mesh.triangle_normals.push_back(v.normal_);
    ...
    std::tuple<TriangleMesh, std::vector<double>>
    create_triangle_mesh_possion(const PointCloud &pcd,
                                 size_t depth,
                                 float width,
                                 float scale,
                                 bool linear_fit,
        ...
        Execute<float>(pcd, mesh, densities, static_cast<int>(depth),
