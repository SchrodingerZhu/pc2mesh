...
namespace pc2mesh::geometry {
    ...
    __attribute__((always_inline)) static inline bool triangle_3d_intersection(
    ...
    __attribute__((always_inline)) static inline bool triange_box_intersection(
        ...
        return tomasakeninemoeller::triBoxOverlap(const_cast<double *>(box_center.data()),
                                                  const_cast<double *>(box_half_size.data()),
                                                  tri_verts) != 0;
    }

    __attribute__((always_inline)) static inline bool points_coplanar(
            const Eigen::Vector3d &p0,
            const Eigen::Vector3d &p1,
            const Eigen::Vector3d &p2,
    ...
    __attribute__((always_inline)) static inline double lines_minimum_distance(
            const Eigen::Vector3d &p1,
            const Eigen::Vector3d &p2,
            const Eigen::Vector3d &p3,
    ...
    __attribute__((always_inline)) static inline double line_segments_minimum_distance(
            const Eigen::Vector3d &p0,
            const Eigen::Vector3d &p1,
            const Eigen::Vector3d &q0,
            const Eigen::Vector3d &q1
